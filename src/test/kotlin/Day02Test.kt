...
class Day02Test : FreeSpec({
    ...
    "part 2" - {
        "example game" {
            ...
            Day02.solveSecondPart(input) shouldBeExactly 48
        }

        "game with no cubes of some color" {
            val input = listOf(
                "Game 3: 8 green, 6 blue; 5 blue, 13 green; 5 green",
            )

            Day02.solveSecondPart(input) shouldBeExactly 0
        }
        ...
        "take the max of all displays and multiplies them to get the power of a set of cubes" {
            ...
            Day02.solveSecondPart(input) shouldBeExactly 20 * 13 * 6
        }
        ...
        "many games => take a sum of their powers (part example)" {
            ...
            Day02.solveSecondPart(input) shouldBeExactly 2286
        }
    }
})
